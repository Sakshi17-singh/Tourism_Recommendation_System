      ...
      <section className="flex-1 relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {[...Array(20)].map((_, i) => (
            ...
            >
              {[FaGlobe, FaCamera, FaCompass, FaMapMarkedAlt, FaPlane, FaHeart][i % 6]({ 
          ...
          <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className={`${isLoaded ? 'animate-in slide-in-from-left-8 duration-1000' : 'opacity-0'} space-y-8`}>
              ...
              <div className="inline-flex items-center gap-3 bg-white/10 dark:bg-slate-800/30 backdrop-blur-xl rounded-full px-6 py-3 border border-white/20 dark:border-slate-700/50">
                ...
                <span className="text-sm font-semibold text-white dark:text-teal-200">Start Your Journey Today!</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl md:text-2xl text-white/90 dark:text-slate-200 leading-relaxed max-w-2xl">
                  Join thousands of travelers exploring Nepal's hidden gems, authentic experiences, and 
                  <span className="font-bold text-sky-300"> unforgettable adventures</span>
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { icon: FaMapMarkedAlt, title: "Curated Routes", desc: "Expert-planned itineraries" },
                  { icon: FaGlobe, title: "Local Insights", desc: "Authentic experiences" },
                  { icon: FaStar, title: "Top Destinations", desc: "Handpicked locations" },
                  { icon: FaShieldAlt, title: "Safe Travel", desc: "Trusted & verified" }
                ].map((feature, index) => (
                  <div 
                    key={index}
              ...
              <div className="w-full max-w-md">
                ...
                <div className="bg-white/10 dark:bg-slate-800/30 backdrop-blur-2xl rounded-3xl p-8 border border-white/20 dark:border-slate-700/50 shadow-2xl relative z-20">
                  ...
                  <div className="space-y-3">
                    {[
                      { icon: FaShieldAlt, text: "Bank-level encryption" },
                      { icon: FaCheckCircle, text: "Verified & secure" },
                      { icon: FaLock, text: "Privacy guaranteed" }
                    ].map((feature, index) => (
